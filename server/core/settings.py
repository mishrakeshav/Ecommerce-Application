...
SECRET_KEY = 'django-insecure-+55l)u$0ln))+pqc2r21osr13)4tv$z0-om_s-w0naiwq#&gtb'
...
#using gmail account for emails
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "The Ecomm Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "The Ecomm",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "The Ecomm",
    ...
    "welcome_sign": "Welcome to the The Ecomm",

    # Copyright on the footer
    "copyright": "Team Hamood",
